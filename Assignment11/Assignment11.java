 ...
 * Name: Sherry Feng
 * StudentID:
 * Lecture: MWF 8:35-9:25am
 * Description: Assignment 11 class displays a menu of choices to a user and performs the chosen task. It will keep
 * asking a user to enter the next choice until the choice of 'Q' (Quit) is entered.
 */
